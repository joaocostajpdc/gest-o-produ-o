...
// PriorityLevel é um valor calculado em runtime (não é guardado na base de
// dados), por isso não é referenciado por nenhum campo do schema.prisma —
// e por isso o Prisma Client não o exporta automaticamente. Definimos aqui
// o mesmo conjunto de valores do enum "PriorityLevel" do schema.prisma.
