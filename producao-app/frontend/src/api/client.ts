...
// Quando o token expira (ao fim de várias horas) ou é rejeitado pelo
// servidor, qualquer pedido à API passa a devolver 401. Sem isto, a app
// ficava "meio autenticada": a barra lateral continuava a mostrar o
// utilizador com sessão iniciada, mas todas as páginas mostravam erro e
// pareciam não reagir a cliques — muito confuso para quem não percebe de
// DevTools. Em vez disso, ao primeiro 401 limpa-se a sessão e envia-se a
// pessoa de volta ao ecrã de login, com um aviso claro do que aconteceu.
